...
# RAG Search
def rag_search(vectorstore, query):
...
# Membuat Agent
def create_agent(api_key, vectorstore):
    ...
    def rag_tool_func(query):
        return rag_search(vectorstore, query)
    ...
    tools = [
        ...
        Tool(name="RAGSearch", func=rag_tool_func, description="Cari informasi masakan dengan FAISS.")
    ]
